import type { ReturnEmailData } from '@shared/lib/return-email-types';
import { RETURN_IT_CC } from '@shared/lib/return-email-types';
import type { SendReturnEmailResult } from '@shared/lib/return-email-types';
...
import { escapeHtml, sendNotificationEmail } from '@backend/server/email/email.server';
