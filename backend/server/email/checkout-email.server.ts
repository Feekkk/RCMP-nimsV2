...
import type { CheckoutEmailData } from '@shared/lib/checkout-email-types';
import { REQUEST_IT_EMAIL } from '@shared/lib/checkout-email-types';
import type { SendCheckoutEmailInput, SendCheckoutEmailResult } from '@shared/lib/checkout-email-types';
...
import { getCheckoutEmailData } from '@backend/server/email/checkout-email-repo.server';
