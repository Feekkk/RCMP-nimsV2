...
import type { RequestReturnEmailData } from '@shared/lib/request-return-email-types';
import { REQUEST_IT_EMAIL } from '@shared/lib/request-return-email-types';
import type {
  SendRequestReturnEmailInput,
  SendRequestReturnEmailResult,
} from '@shared/lib/request-return-email-types';
...
import { getRequestReturnEmailData } from '@backend/server/email/request-return-email-repo.server';
