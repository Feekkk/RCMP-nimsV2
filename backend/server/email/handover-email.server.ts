import type { HandoverEmailData } from '@shared/lib/handover-email-types';
import type { SendHandoverEmailResult } from '@shared/lib/handover-email-types';
...
import { markHandoverEmailStatus } from '@backend/server/email/handover-email-repo.server';
